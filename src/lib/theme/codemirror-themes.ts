...
const codemirrorThemes = [
    ...
    // ayu-light.ts
    {
        ...
        styles: [
            ...
            { tag: [t.definition(t.propertyName), t.function(t.variableName)], color: '#f2ae49' },
    ...
    // barf.ts
    {
        ...
        styles: [
            ...
            { tag: [t.definitionKeyword, t.modifier, t.function(t.propertyName)], color: '#A3D295', fontWeight: 'bold' },
            { tag: [t.keyword, t.moduleKeyword, t.operatorKeyword, t.operator], color: '#697A8E', fontWeight: 'bold' },
            { tag: [t.variableName, t.attributeName], color: '#708E67' },
            { tag: [t.function(t.variableName), t.definition(t.propertyName), t.derefOperator], color: '#fff' },
    ...
    // bespin.ts
    {
        ...
        styles: [
            ...
            { tag: [t.propertyName, t.function(t.variableName)], color: '#937121' },
            { tag: [t.typeName, t.angleBracket, t.tagName], color: '#9B859D' },
        ],
    },

    // birds-of-paradise.ts
    {
        variant: 'dark',
        settings: {
            background: '#3b2627',
        ...
        styles: [
            ...
            { tag: [t.typeName, t.propertyName, t.function(t.variableName), t.definition(t.variableName)], color: '#EFAC32' },
    ...
    // boys-and-girls.ts
    {
        ...
        styles: [
            ...
            { tag: [t.variableName, t.attributeName, t.self], color: '#E62286', fontWeight: 'bold' },
    ...
    // cobalt.ts
    {
        ...
        styles: [
            ...
            { tag: [t.className, t.definition(t.propertyName), t.function(t.variableName), t.definition(t.typeName), t.labelName], color: '#FFDD00' },
    ...
    // cool-glow.ts
    {
        ...
        styles: [
            ...
            { tag: [t.className, t.definition(t.propertyName), t.function(t.variableName), t.function(t.definition(t.variableName)), t.definition(t.typeName)], color: '#A3EBFF' },
            ...
            { tag: [t.angleBracket, t.tagName, t.typeName, t.propertyName], color: '#60A4F1' },
    ...
    // dracula.ts
    {
        ...
        styles: [
            ...
            { tag: [t.className, t.definition(t.propertyName), t.function(t.variableName), t.attributeName], color: '#50fa7b' },
        ],
    },
    ...
    // espresso.ts
    {
        ...
        styles: [
            ...
            { tag: [t.keyword, t.operator, t.typeName, t.tagName, t.propertyName], color: '#2F6F9F', fontWeight: 'bold' },
            { tag: [t.attributeName, t.definition(t.propertyName)], color: '#4F9FD0' },
    ...
    // smoothy.ts
    {
        ...
        styles: [
            ...
            { tag: [t.className, t.definition(t.propertyName), t.function(t.variableName), t.labelName, t.definition(t.typeName)], color: '#2EB43B' },
    ...
    // solarized-light.ts
    {
        ...
        styles: [
            ...
            { tag: [t.definitionKeyword, t.modifier], color: '#073642', fontWeight: 'bold' },
            { tag: [t.className, t.self, t.definition(t.propertyName)], color: '#268BD2' },
